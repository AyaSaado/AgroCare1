...
namespace AgroCare1.Migrations
{
    ...
    [Migration("20230708205406_intiail_db")]
    partial class intiail_db
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.AgriculturalItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Engineer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.EngineerType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Land", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.LandType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.SoilType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.StepDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.StoreType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Engineer", b =>
                {
                    b.HasOne("Models.EngineerType", "EngineerType")
                        .WithMany("Engineers")
                        .HasForeignKey("EngineerTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_Engineer_Engineer_Type");

                    b.HasOne("Models.Engineer", "HeadEngineer")
            ...
            modelBuilder.Entity("Models.Land", b =>
                {
                    ...
                    b.HasOne("Models.SoilType", "SoilType")
                        .WithMany("Lands")
                        .HasForeignKey("SoilTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_Land_Soil_Type");

                    b.HasOne("Models.LandType", "Type")
                        .WithMany("Lands")
            ...
            modelBuilder.Entity("Models.Order", b =>
                {
                    b.HasOne("Models.Engineer", "AdminEngineer")
                    ...
                    b.HasOne("Models.Engineer", "ExecutiveTeam")
            ...
            modelBuilder.Entity("Models.Plan", b =>
                {
                    b.HasOne("Models.Land", "Land")
                        .WithMany("Plans")
                        .HasForeignKey("LandId")
                        .IsRequired()
                        .HasConstraintName("FK_Order_Distribution_Land");

                    b.HasOne("Models.OrderDetail", "OrderDetails")
                        .WithMany("Plans")
            ...
            modelBuilder.Entity("Models.Store", b =>
                {
                    b.HasOne("Models.StoreType", "Type")
                        .WithMany("Stores")
                        .HasForeignKey("TypeId")
                        .IsRequired()
